...
public class App extends Activity implements CvCameraViewListener {
    ...
    private void onRecord(MenuItem item) {
        ...
        if (recording) {
            ...
            new PostBPMToServer((eTime - sTime),recordedBpmAverage, mSignalStr).start();
        }
    }
    ...
    class PostBPMToServer extends Thread {
		...
		public void run() {
			super.run();
			String uri = "http://192.168.1.8:3000/hearts/new_from_mobile?duration=" + mTime + "&device=" + android.os.Build.MODEL;
